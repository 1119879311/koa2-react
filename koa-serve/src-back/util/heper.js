...
exports.splitobj=(obj = {}, live = "=") => {//对象键值拼接
    var str = ''
    for (var i in obj) {
        str += `${i} ${live}'${obj[i]}'`
    }
...
exports.md5 =(pwd, key=pwd) => { //md5 加密
...
exports.dataFormat = (date, format = "yyyy-MM-dd") => {//参数一:时间，参数，要显示的时间格式
...
//递归对象， 实现一维数据结构
let recurOne= function (data = [], id = "id", pid = "pid", pidnum = 0, leve = 1) {//关联值 id and tid  = 0(定级)
...
let  filterChrildId =  (data = [], id = "id", pid = "pid", idNum = 0,field=null)=> {//默认没有子集，返回空数组
