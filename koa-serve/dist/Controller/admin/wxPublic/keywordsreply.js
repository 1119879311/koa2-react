...
let index = (_dec = Controller("/keywordsReply"), _dec2 = GET("/"), _dec3 = userAuth(), _dec4 = roleAuth(), _dec5 = POST("/add"), _dec6 = userAuth(), _dec7 = roleAuth(), _dec8 = POST("/swtich"), _dec9 = userAuth(), _dec10 = roleAuth(), _dec11 = POST("/update"), _dec12 = userAuth(), _dec13 = roleAuth(), _dec14 = POST("/delete"), _dec(_class = (_class2 = class index {
