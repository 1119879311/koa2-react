...
let index = (_dec = Controller("/role"), _dec2 = GET("/"), _dec3 = POST("/add"), _dec4 = POST("/update"), _dec5 = POST("/delete"), _dec6 = POST("/swtich"), _dec7 = POST("/assginAuth"), _dec8 = POST("/assginMenu"), _dec(_class = (_class2 = class index extends roleBase {
    ...
    * @param return {code,mssage/errmsg,data,status}
    ...
    async update(ctx, next) {
        var { id, name, title } = ctx.request.body;
        // 数据验证
    ...
    **/
    ...
    /**给角色分配菜单
     * @param POST /role/assginMenu
     * @param {number} id 
     * @param {array} menuArrId [1,2] or [{id,1,id:2}]
     * @param return {code,mssage/errmsg,data,status}   
     **/

    async assginMenu(ctx, next) {
        var { id, menuArrId } = ctx.request.body;
        if (Object.prototype.toString.call(menuArrId) == "[object Object]") {
            menuArrId = Object.values(menuArrId);
        }
        if (!id || !Array.isArray(menuArrId)) {
            return ctx.body = await ctx.error("id  is required or menuArrId type is array");
        }
        ctx.body = await ctx.send((await roleModel.assginMenu(id, menuArrId)));
    }
}, (_applyDecoratedDescriptor(_class2.prototype, "findUser", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "findUser"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "add"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "update", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "update"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "delete", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "delete"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "swtich", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "swtich"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "assginAuth", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "assginAuth"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "assginMenu", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "assginMenu"), _class2.prototype)), _class2)) || _class);
