...
export class index extends Component {
  ...
  // 获取表格数据
   getTableData=()=>{
    ...
    axios.GET("cmsTab",{status:0}).then( async res=>{
  ...
  render() {
    const { loading,selectedRowKeys,multipleSelection,rendTableData,modalTitle,addEditTabIshow,tabFromData } = this.state;
    const rowSelection = {
      selectedRowKeys,
